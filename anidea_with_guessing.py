...
try:
    with open(filename, "r") as f:
        ...
        # Let the user guess the total area
        correctGuess = False
        areaGuess = input("Enter your guess for the area: ")
        while(correctGuess == False): 
            ...
            for i in areaGuess:
                if (i != '0' and i != '1' and i != '2' and i != '3' and i != '4' and i != '5' and i != '6' and i != '7' and i != '8' and i != '9'):
                    skipOver = True
                    areaGuess = input("Please enter a guess that has numbers: ")
                    break
            
            if (skipOver == True):
                continue
            else:
                correctGuess = float(areaGuess) == areaTotal;
            
            if(correctGuess == True):
                break
            
            if int(areaGuess) < areaTotal:
                areaGuess = input("That guess was too low, try again: ")
            else:
                areaGuess = input("That guess was too high, try again: ")
        
        print()
        print("Correct! The total area of the figure is", areaTotal, "units squared.\n")
